...
func _handle_combat(delta):
	...
	movement_lock = current_state in ["Light_Damaged_L","Attack_1", "Attack_2", "Attack_3", "Attack_4", "Attack_5", "Attack_6", "Attack_roll", "Attack_C_1", "Attack_C_1_bash", "death_01", "Attack_bash", "in_to_H_Attack_1", "H_Attack_2"] or stunned
